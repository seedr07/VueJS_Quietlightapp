  ...
  methods: {
    update: function(){
      ...
      if(this.$parent.$parent.fetchingSections) return;
		alert(comp.financial.id);
      store.updateFinancialV2(comp.financial.id, 
            comp.financial.file, comp.financial.output_template, comp.financial.graph1, comp.financial.graph2, comp.financial.graph1_data, comp.financial.graph2_data, comp.financial.table1, comp.financial.table2);
