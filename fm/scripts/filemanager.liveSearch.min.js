String.prototype.score=function(b,g){g=g||0;if(0==b.length)return.9;if(b.length>this.length)return 0;for(var a=b.length;0<a;a--){var c=b.substring(0,a),d=this.indexOf(c);if(!(0>d||d+b.length>this.length+g)){var c=this.substring(d+c.length),e=null,e=a>=b.length?"":b.substring(a),e=c.score(e,g+d);if(0<e){a=this.length-c.length;if(0!=d){var h=0,f=this.charCodeAt(d-1);if(32==f||9==f)for(h=d-2;0<=h;h--)f=this.charCodeAt(h),a-=32==f||9==f?1:.15;else a-=d}a+=e*c.length;return a/=this.length}}}return 0};
